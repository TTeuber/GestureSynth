...
MySynthVoice::MySynthVoice (juce::AudioProcessorValueTreeState& p, juce::ValueTree& mt, std::shared_ptr<MyADSR*> ampEnvPtr)
    : parameters (p), modTree (mt), env1ptr (std::move (ampEnvPtr))
{
